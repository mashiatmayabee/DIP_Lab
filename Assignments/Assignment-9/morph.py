...
def main():
    img = plt.imread('/home/mayabee/Documents/DIP_Lab/Assignments/Assignment-8/damaged.jpg')
    print(img.shape)
    grayscale = cv2.cvtColor(img,cv2.COLOR_RGB2GRAY)
    print(grayscale.shape)
    _,binaryImg = cv2.threshold(grayscale,100,255,cv2.THRESH_BINARY)
    ...
    title_set = ['Binary Image','Built-in Erosion','Implemented Erosion','Built-in dilation','Implemented Dilation','Built-in opening','Implemented opening','Built-inClosing','Implemented Closing']
