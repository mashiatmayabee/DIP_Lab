...
def main():
    rgbImg = plt.imread('/home/mayabee/Documents/DIP_Lab/cactus.jpg')
    print(rgbImg.shape)
    ...
    ftimg_gf = centeredfti_img * filter3
    filtered_img = np.abs(np.fft.ifft2(ftimg_gf))

    
    img_set = [rgbImg, gray, magnitude_spectrum, centered_magnitude_spectrum, filter3, filtered_img]
